...
*   export is literally "Consultant".
  constants C_FLD_SEARCH type STRING value 'MY_COMPONENT' ##NO_TEXT.
...
*   TOSAVE'd on its own: what reaches the backend is the carriers below.
  constants C_FLD_GRID type STRING value 'CONSULTANTS' ##NO_TEXT.
*   The third declaration, above the two the base already knows about.
  constants C_FLD_AGREE type STRING value 'CHECKBOX1' ##NO_TEXT.
*   Carriers - TOSAVE in the export, no control on the screen.
  constants C_FLD_BP type STRING value 'CONSULTANT_BP' ##NO_TEXT.
  constants C_FLD_NAME type STRING value 'CONSULTANTNAME' ##NO_TEXT.
  constants C_FLD_LICENCE type STRING value 'TRADELICENSE' ##NO_TEXT.
  constants C_FLD_EXPIRY type STRING value 'LICENSEEXPIRY' ##NO_TEXT.
  constants C_FLD_GRADE type STRING value 'GRADE' ##NO_TEXT.
*   The step the consultant is added on. STP1 is 0, STP2 is 1.
  constants C_STEP_CONSULTANT type I value 1 ##NO_TEXT.
